      ...
      <div className="grid gap-12 md:grid-cols-[280px_1fr] md:gap-16">
        ...
        <div>
          ...
          <div className="mt-6 space-y-4 text-[var(--color-ink-soft)]">
            <p>
              Jeg hedder {business.name}, og jeg er ergoterapeut med en masse
              gode redskaber i kufferten. Sammen med min assistent{" "}
              {business.assistantName} hjælper jeg børn, unge og voksne med
              neurodivergens, sanseforstyrrelser og belastningsreaktioner.
            </p>
            <p>
              Jeg fokuserer meget på psykoedukation og mestringsforløb, både
              virtuelt og i dit eget hjem. Mine forløb går blandt andet ud på,
              at forældre lærer om deres barns neurodivergens og får
              værktøjer til at støtte barnet i de problemer, der opleves.
              Derudover har jeg forløb, der hjælper dig med at lære din egen
              neurodivergens at kende, og forløb der giver dig redskaber til
              at mestre din angst, ud fra evidensbaserede metoder.
            </p>
          </div>
